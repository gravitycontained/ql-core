...
namespace ql
{
  ...
  template <ql::u32 base, bool sign> struct dynamic_integer;
  template <ql::size bits, bool sign> struct integer;
  template <ql::size bits, bool sign> struct x64_integer;
  template <typename E> struct big_float_t;
  ...
  template <ql::u32 base> using ubase = ql::dynamic_integer<base, 0>;
  template <ql::u32 base> using ibase = ql::dynamic_integer<base, 1>;
