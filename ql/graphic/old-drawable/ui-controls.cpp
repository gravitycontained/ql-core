...
namespace ql
{
	...
	void ql::vbutton::update(const event& event)
	{
	...
	void ql::button::update(const event& event)
	{
		auto pos = event.mouse_position();
	...
	void ql::button::update(const event& event, bool& hovering)
	{
		this->update(event);
	...
	void ql::text_field::update_mouse_events(const ql::event& event)
	{
	...
	void ql::text_field::update(const ql::event& event)
	{
	...
	void ql::color_picker::update(const ql::event& event)
	{
		if (!this->visible)
		{
			return;
	...
	void ql::scroll_bar::update_hover(const ql::event& event)
	{
	...
	void ql::scroll_bar::update_background_hover(const ql::event& event)
	{
	...
	void ql::scroll_bar::update(const ql::event& event)
	{
	...
	{
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "string: ", this->string.string());
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "input string: ", this->input_string.string());
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "string and input: ", this->string_and_input.string());
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "string split: ", this->string_split);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "input string split: ", this->input_string_split);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "string and input split: ", this->string_and_input_split);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "selection rectangle: ", this->selection_rectangle.size());
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "selection rectangle start: ", this->selection_rectangle_start);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "selection rectangle end: ", this->selection_rectangle_end);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "view: ", this->view.position, " ", this->view.scale);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "dimension: ", this->dimension);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "zooms: ", this->zooms);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "view row: ", this->view_row);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "visible rows: ", this->visible_rows);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "scroll bar: ", this->scroll_bar.get_progress());
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "cursor interval duration: ", this->cursor_interval_duration);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "cursor: ", this->cursor.get_position());
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "scroll transition start: ", this->scroll_transition_start);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "scroll transition end: ", this->scroll_transition_end);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "scroll bar transition start: ", this->scroll_bar_transition_start);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "scroll bar transition end: ", this->scroll_bar_transition_end);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "selection rectangle color: ", this->selection_rectangle_color);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "shadow border color: ", this->shadow_border_color);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "visible y min: ", this->visible_y_min);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "visible y max: ", this->visible_y_max);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "visible buffer: ", this->visible_buffer);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "before input vertices size: ", this->before_input_vertices_size);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "before input outline vertices size: ", this->before_input_outline_vertices_size);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "before input unicode vertices size: ", this->before_input_unicode_vertices_size);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "before input unicode outline vertices size: ", this->before_input_unicode_outline_vertices_size);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "before input text rows: ", this->before_input_text_rows);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "before input text position: ", this->before_input_text_position);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "cursor position: ", this->cursor_position);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "clicked mouse position: ", this->clicked_mouse_position);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "character size: ", this->character_size);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "input history: ", this->input_history);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "input history index: ", this->input_history_index);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "accept input: ", this->accept_input);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "hidden input: ", this->hidden_input);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "text entered: ", this->text_entered);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "line entered: ", this->line_entered);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "text dragging: ", this->text_dragging);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "allow text dragging: ", this->allow_text_dragging);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "allow going up with cursor: ", this->allow_going_up_with_cursor);
		ql::println(ql::color::bright_yellow, "core ", ql::color::bright_gray, ":: ", "border texture set: ", this->border_texture_set);
	}
	...
	void ql::console::update_key_input(const ql::event& event)
	{
	...
	void ql::console::update_selection_rectangle(const ql::event& event)
	{
	...
	void ql::console::update(const ql::event& event)
	{
