...
namespace ql
{
	...
	{
		ql::println(ql::color::bright_yellow, "string: ", this->string.string());
		ql::println(ql::color::bright_yellow, "input string: ", this->input_string.string());
		ql::println(ql::color::bright_yellow, "string and input: ", this->string_and_input.string());
		ql::println(ql::color::bright_yellow, "string split: ", this->string_split);
		ql::println(ql::color::bright_yellow, "input string split: ", this->input_string_split);
		ql::println(ql::color::bright_yellow, "string and input split: ", this->string_and_input_split);
		ql::println(ql::color::bright_yellow, "selection rectangle: ", this->selection_rectangle.size());
		ql::println(ql::color::bright_yellow, "selection rectangle start: ", this->selection_rectangle_start);
		ql::println(ql::color::bright_yellow, "selection rectangle end: ", this->selection_rectangle_end);
		ql::println(ql::color::bright_yellow, "view: ", this->view.position, " ", this->view.scale);
		ql::println(ql::color::bright_yellow, "dimension: ", this->dimension);
		ql::println(ql::color::bright_yellow, "zooms: ", this->zooms);
		ql::println(ql::color::bright_yellow, "view row: ", this->view_row);
		ql::println(ql::color::bright_yellow, "visible rows: ", this->visible_rows);
		ql::println(ql::color::bright_yellow, "scroll bar: ", this->scroll_bar.get_progress());
		ql::println(ql::color::bright_yellow, "cursor interval duration: ", this->cursor_interval_duration);
		ql::println(ql::color::bright_yellow, "cursor: ", this->cursor.get_position());
		ql::println(ql::color::bright_yellow, "scroll transition start: ", this->scroll_transition_start);
		ql::println(ql::color::bright_yellow, "scroll transition end: ", this->scroll_transition_end);
		ql::println(ql::color::bright_yellow, "scroll bar transition start: ", this->scroll_bar_transition_start);
		ql::println(ql::color::bright_yellow, "scroll bar transition end: ", this->scroll_bar_transition_end);
		ql::println(ql::color::bright_yellow, "selection rectangle color: ", this->selection_rectangle_color);
		ql::println(ql::color::bright_yellow, "shadow border color: ", this->shadow_border_color);
		ql::println(ql::color::bright_yellow, "visible y min: ", this->visible_y_min);
		ql::println(ql::color::bright_yellow, "visible y max: ", this->visible_y_max);
		ql::println(ql::color::bright_yellow, "visible buffer: ", this->visible_buffer);
		ql::println(ql::color::bright_yellow, "before input vertices size: ", this->before_input_vertices_size);
		ql::println(ql::color::bright_yellow, "before input outline vertices size: ", this->before_input_outline_vertices_size);
		ql::println(ql::color::bright_yellow, "before input unicode vertices size: ", this->before_input_unicode_vertices_size);
		ql::println(ql::color::bright_yellow, "before input unicode outline vertices size: ", this->before_input_unicode_outline_vertices_size);
		ql::println(ql::color::bright_yellow, "before input text rows: ", this->before_input_text_rows);
		ql::println(ql::color::bright_yellow, "before input text position: ", this->before_input_text_position);
		ql::println(ql::color::bright_yellow, "cursor position: ", this->cursor_position);
		ql::println(ql::color::bright_yellow, "clicked mouse position: ", this->clicked_mouse_position);
		ql::println(ql::color::bright_yellow, "character size: ", this->character_size);
		ql::println(ql::color::bright_yellow, "input history: ", this->input_history);
		ql::println(ql::color::bright_yellow, "input history index: ", this->input_history_index);
		ql::println(ql::color::bright_yellow, "accept input: ", this->accept_input);
		ql::println(ql::color::bright_yellow, "hidden input: ", this->hidden_input);
		ql::println(ql::color::bright_yellow, "text entered: ", this->text_entered);
		ql::println(ql::color::bright_yellow, "line entered: ", this->line_entered);
		ql::println(ql::color::bright_yellow, "text dragging: ", this->text_dragging);
		ql::println(ql::color::bright_yellow, "allow text dragging: ", this->allow_text_dragging);
		ql::println(ql::color::bright_yellow, "allow going up with cursor: ", this->allow_going_up_with_cursor);
		ql::println(ql::color::bright_yellow, "border texture set: ", this->border_texture_set);		
	}
