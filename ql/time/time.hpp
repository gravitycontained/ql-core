...
#include <ql/advanced-type/iterative/ema.hpp>
...
namespace ql
{
	...
	QL_SOURCE std::ostream& operator<<(std::ostream& os, const ql::time& time);
	...
	QL_SOURCE std::ostream& operator<<(std::ostream& os, const ql::clock& clock);
	QL_SOURCE std::ostream& operator<<(std::ostream& os, const ql::halted_clock& clock);
