...
namespace ql
{
  namespace impl
  {
    ...
    struct possibilities_iterator
    {
      ...
      constexpr possibilities_iterator(const std::array<T, N> &max)
          : min(), values(), max()
      {
        this->values.fill(T{});
        this->max = max;
      ...
      constexpr possibilities_iterator(const std::array<T, N> &min,
                                       const std::array<T, N> &max)
          : min(), values(), max()
      {
        this->values = min;
        this->min = min;
    ...
    struct possibilities_reverse_iterator
    {
      ...
      constexpr possibilities_reverse_iterator(const std::array<T, N> &max)
          : min(), values(), max()
      {
        this->values = max;
        for(auto &i : this->values)
    ...
    struct possibilities
    {
      ...
      constexpr possibilities(const std::array<T, N> &min,
                              const std::array<T, N> &max)
          : min(), max()
      {
        this->min = min;
    ...
    struct reverse_possibilities
    {
      ...
      constexpr reverse_possibilities(const std::array<T, N> &max)
          : min(), max()
      {
        this->max = max;
      }

      constexpr reverse_possibilities(const std::array<T, N> &min,
                                      const std::array<T, N> &max)
          : min(), max()
      {
        this->min = min;
